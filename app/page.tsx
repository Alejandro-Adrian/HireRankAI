    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-100 to-blue-100">
      ...
      <header className="flex items-center justify-between px-8 py-6">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-2xl font-bold text-gray-900">HireRank AI</span>
        </div>
        ...
        <div className="flex-1 max-w-2xl">
          ...
          <div className="grid grid-cols-2 gap-8">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-gray-700 font-medium">AI Ranking</span>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-gray-700 font-medium">Video Interviews</span>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-gray-700 font-medium">Resume Analysis</span>
            </div>
      ...
      <div className="px-8 py-16 text-center">
        <h2 className="text-4xl font-bold text-gray-900 mb-6">Everything You Need for Smart Hiring</h2>
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          From candidate screening to final interviews, HireRank AI streamlines your entire hiring workflow
        </p>
      </div>
    </div>
  )
