...
export async function POST(request: NextRequest, { params }: { params: { id: string } }) {
  try {
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f8f9fa; padding: 30px; border-radius: 0 0 10px 10px; border: 1px solid #e9ecef;">
            ...
            <div style="background: white; padding: 20px; border-radius: 8px; border-left: 4px solid #28a745; margin: 20px 0;">
              <h3 style="color: #28a745; margin-top: 0;">Your Application Results:</h3>
              <p style="margin: 5px 0;"><strong>Ranking:</strong> #${application.rank || "N/A"}</p>
              <p style="margin: 5px 0;"><strong>Score:</strong> ${application.total_score || "N/A"}%</p>
            </div>
    ...
    const textContent = `
      ...
      - Ranking: #${application.rank || "N/A"}
      - Score: ${application.total_score || "N/A"}%
