        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Video Call Manager</h1>
                <p className="text-gray-600">Create and manage interview sessions</p>
              </div>
            </div>
            <button
      ...
      <div className="p-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-semibold text-gray-900">Video Sessions</h2>
          </div>
          ...
          {loading ? (
            ...
            <div className="p-12 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No video sessions yet</h3>
              <p className="text-gray-500 mb-6">Create your first video session to start interviewing candidates</p>
              <button
                onClick={() => setShowCreateModal(true)}
                ...
                <div key={session.id} className="p-6 hover:bg-gray-50 transition-colors">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">Meeting ID: {session.meeting_id}</p>
                    </div>
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Create Video Session</h3>
      ...
      {showSendModal && selectedSession && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[80vh] overflow-y-auto">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Send Invitation: {selectedSession.title}</h3>
