        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-6">
                        ...
                        notifications.map((notification) => (
                          ...
                          >
                            <div className="flex items-start justify-between">
                              <p
                                className={`text-sm ${!notification.read ? "font-medium" : ""} text-gray-900 dark:text-gray-100`}
                              >
              ...
              <button
                onClick={onLogout}
                className="flex items-center space-x-2 p-2 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg"
              >
        ...
        <div className="flex gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              {metrics.map((metric, index) => (
                <div
                  ...
                  className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 cursor-pointer hover:shadow-md hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-200"
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">{metric.title}</p>
                      <p className="text-3xl font-bold text-gray-900 dark:text-white">{metric.value}</p>
                    </div>
                    <div className={`p-3 rounded-lg ${metric.color} dark:bg-opacity-20`}>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
              <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Job Rankings</h2>
                  <button
              ...
              {loading ? (
                <div className="p-12 text-center">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 mt-4">Loading rankings...</p>
                </div>
                  ...
                  {rankings.length === 0 ? (
                    ...
                    <>
                      ...
                      <Button
                        ...
                        className="flex items-center gap-2 mx-auto border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700"
                      >
                        <X className="w-4 h-4" />
                        Clear All Filters
                      </Button>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex-1">
                            <div className="flex items-center space-x-3 mb-2">
                              <h3 className="text-lg font-medium text-gray-900 dark:text-white">{ranking.title}</h3>
                              <span
                            ...
                            <p className="text-gray-600 dark:text-gray-300 mb-2">{ranking.description}</p>
          ...
          <div className="w-80 space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">Common tasks and shortcuts</p>

              <div className="space-y-3">
                <button
                  onClick={handleCreateRanking}
                  className="flex items-center space-x-3 w-full p-3 text-left text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors"
                >
                ...
                <button
                  ...
                  className="flex items-center space-x-3 w-full p-3 text-left text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p
                      className={`font-medium ${rankings.length > 0 ? "text-green-600 dark:text-green-400" : "text-gray-900 dark:text-white"}`}
                    >
                      Create a ranking
                    </p>
                ...
                <div className="flex items-start space-x-3">
                  <div className="flex-shrink-0 w-6 h-6 bg-gray-300 dark:bg-gray-600 text-white text-sm font-medium rounded-full flex items-center justify-center">
                    2
                  </div>
                  <div>
                    <p className="font-medium text-gray-500 dark:text-gray-400">Share application link</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Send the link to candidates to apply</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-500 dark:text-gray-400">Review results</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">AI will rank and score candidates</p>
                  </div>
                </div>
              </div>
            </div>
